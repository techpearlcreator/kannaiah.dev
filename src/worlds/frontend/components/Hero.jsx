...
const Hero = () => {
  return (
    <section className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-lilac-light px-5 pb-24 pt-36 text-center sm:px-8 sm:pb-32 sm:pt-32 md:px-10">
      {/* Background Blobs */}
      ...
      <motion.h1
        ...
        className="z-10 mb-6 text-[clamp(3rem,16vw,10rem)] font-sans font-bold leading-[0.92] tracking-tighter sm:mb-8"
      >
        Crafting digital <br />
      ...
      <motion.p
        ...
        className="z-10 max-w-3xl text-sm leading-7 sm:text-base md:text-xl md:leading-relaxed"
      >
      ...
      <motion.div
        ...
        className="z-10 mt-7 flex flex-wrap items-center justify-center gap-4 sm:mt-8"
      >
        {socialLinks.map(({ label, href, Icon }) => (
          <a
            ...
            className="group inline-flex h-12 w-12 items-center justify-center text-black/70 transition duration-300 hover:-translate-y-1 hover:scale-110 hover:text-black sm:h-14 sm:w-14"
          >
            <Icon size={30} />
          </a>
        ))}
      ...
      <div className="absolute bottom-5 left-1/2 hidden -translate-x-1/2 flex-col items-center opacity-30 sm:flex">
        <span className="text-[10px] tracking-[0.4em] uppercase font-bold mb-4 ">Scroll to Explore</span>
