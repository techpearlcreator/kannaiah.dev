 ...
 * LiquidProjectCard
 * ──────────────────────────────────────────────────────────────
 * - Layout: Title (Left) | Canvas (Center) | Info (Right)
 * - Premium minimal design inspired by high-end studios.
 * - Sharp typography outside WebGL.
 */
const LiquidProjectCard = ({ title, description, image, tags, link, isActive, isMobile }) => {
  ...
  return (
    ...
    >
      ...
      <div 
        ref={titleRef}
        className="w-full md:w-[30%] flex flex-col justify-center z-20"
      >
      ...
      <div 
        ref={infoRef}
        className="w-full md:w-[25%] flex flex-col gap-8 justify-center z-20"
      >
      ...
      {/* Background Page Number or Decorative Text */}
      {!isMobile && (
